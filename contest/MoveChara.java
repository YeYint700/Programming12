...
public class MoveChara {
    ...
    WalkingSound = new MediaPlayer(new Media(new File("sound/WalkingSE01.mp3").toURI().toString()));
    BumpSound = new MediaPlayer(new Media(new File("sound/BumpSE01.mp3").toURI().toString()));
